...
const ExperienceItem = ({item}: {item: ExpType}) => {
    return (
        <div className={"main-container"}>
            ...
            <div className="grid grid-cols-5 gap-12 myBox gray">
                ...
                <div className={" col-span-3 "}>
                    <div className="flex text-sky-700 mb-2 justify-between">
                        <span>Position:</span> <span className={"text-gradient"}>{item.position}</span>
                    </div>
                    <div className="flex text-sky-700 mb-2 justify-between">
            ...
            <img src="/assets/astro.svg" className={"absolute  bottom-[17vh] right-80"} alt={item.name} />
            <img src="/assets/scientist.svg" className={"absolute  bottom-[15vh] right-20"} alt={item.name} />
        </div>
    );
};
